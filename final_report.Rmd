...
All variables are well represented in Factor 1. Variables that increase annually i.e., GNP, GNP
deflator, Population, Year and Employed have the largest values. Factor 2 mainly consists of Unemployment and Armed forces.
...
![Modified model](images/dia2-01.PNG "Modified model")
